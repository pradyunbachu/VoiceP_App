...
const NON_PANTRY_PATTERN =
  /\b(air freshener|freshener|febreze|glade|bleach|windex|lysol|sponge|steel wool|dish soap|dishwasher pod|dishwasher tablet|rinse aid|laundry detergent|detergent|fabric softener|dryer sheet|stain remover|cleaning spray|disinfectant|disinfecting wipe|clorox|pine sol|comet|mop|broom|duster|vacuum bag|lint roller|all purpose cleaner|glass cleaner|floor cleaner|scrub brush|oven cleaner|paper towel|trash bag|garbage bag|paper plate|plastic cup|styrofoam|plastic wrap|cling wrap|ziploc|sandwich bag|shampoo|conditioner|body wash|soap bar|bar soap|body lotion|toothpaste|toothbrush|deodorant|lotion|razor|floss|mouthwash|tampon|toilet paper|tissue|cotton ball|cotton swab|q-tip|sunscreen|hand soap|hand sanitizer|face wash|face cream|moisturizer|makeup|mascara|lip balm|nail polish|hair spray|hair gel|hair tie|bobby pin|contact solution|eye drop|band aid|bandage|first aid|ibuprofen|tylenol|advil|aspirin|dog food|cat food|cat litter|pet treat|pet food|dog treat|pet shampoo|flea treatment|puppy pad|diaper|baby wipe|pacifier|batteries|battery|light bulb|candle|matches|lighter|laundry basket|hanger|clothespin|dish rack|dish towel|oven mitt|tupperware|storage bin|extension cord|duct tape|super glue|wrapping paper|gift wrap|gift bag|greeting card)\b/;
