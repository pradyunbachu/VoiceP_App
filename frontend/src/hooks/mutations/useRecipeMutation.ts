...
export const useRecipeDetail = () => {
  ...
  return useMutation<RecipeDetail, Error, RecipeDetailVariables>({
    mutationFn: async ({ meal_name, meal_description, available_ingredients }: RecipeDetailVariables): Promise<RecipeDetail> => {
